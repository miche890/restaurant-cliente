        ...
        <div className="lg:flex">
          <div className="lg:w-5/12 xl:w-3/12">
            ...
            <div className="sm:flex sm:-mx-2 pl-2">
              <label className="mt-5 sm:w-2/4">
                <span className="block text-gray-800 mb-2">Existencia</span>
                <select
                  className="bg-white shadow appearance-none border rounded w-full p-2 leading-tight focus:outline-none focus:shadow-sm focus:shadow-blue-700/50"
                  value={existencia}
                  ref={existenciaRef}
