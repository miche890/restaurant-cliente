  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      descripcion: Yup.string()
        .min(10, "La descripcion del platillo debe ser más larga")
        ...
        <div className="w-full max-w-3xl">
          <form onSubmit={formik.handleSubmit}>
            ...
            <div className="mb-4">
              ...
              <textarea
                className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-sm focus:shadow-blue-700/50 h-40"
                id="descripcion"
